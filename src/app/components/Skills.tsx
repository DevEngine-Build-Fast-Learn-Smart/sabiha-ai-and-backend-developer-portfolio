  ...
  const skillCategories = [
    {
      ...
      skills: ['PyTorch', 'Transformers', 'CNN', 'Deep Learning', 'OpenCV', 'NLP'],
      gradient: 'from-violet-500 to-purple-500'
    },
    {
      icon: Server,
      title: 'Backend Development',
      skills: ['Python','Django', 'FastAPI', 'Node.js', 'Express.js', 'REST API'],
    ...
    },
    {
      ...
      skills: ['Pandas', 'NumPy', 'Scikit-learn', 'FAISS', 'LangChain', 'ChromaDB'],
