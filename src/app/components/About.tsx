  ...
  const highlights = [
    {
      ...
      description: 'Passion for AI, Machine Learning, Backend Engineering, and Data Science',
      gradient: 'from-violet-500 to-purple-500'
    },
    {
      icon: Sparkles,
      title: 'Research-Driven Mindset',
      description: 'Continuously exploring cutting-edge algorithms and state-of-the-art AI architectures',
      gradient: 'from-purple-500 to-pink-500'
    },
    {
      icon: Database,
      title: 'Real-World AI Solutions',
      description: 'Focused on solving complex, practical challenges with intelligent and reliable systems',
      gradient: 'from-cyan-500 to-blue-500'
    },
    {
      icon: Code2,
      title: 'Scalable Engineering',
      description: 'Collaborative, high-performance, and resilient backend architecture design',
